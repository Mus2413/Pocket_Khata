...
class ExistingUserData extends StatefulWidget {
  final String uniqueid;
   ExistingUserData(this.uniqueid);
  @override
  _ExistingUserDataState createState() => _ExistingUserDataState();
}

class _ExistingUserDataState extends State<ExistingUserData> {
  int selectedIndex=0;
  ...
  void initState()  {
    ...
    print(widget.uniqueid);
     DatabaseMethods().getdata(Constants.myemail,widget.uniqueid).then((val) {
      setState(() {
        Information = val;
      });
    });
...
class MessageTile extends StatelessWidget {
  ...
  @required this.itemdetail,@required this.duration, @required this.name,@required this.paidamount,
                    ...
                    child: Padding(
                      ...
                      child: GestureDetector(
                        onTap:() {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder:  (context) =>PayScreen(phone,time.toString())));
                        },
                        ...
                        child: new Container(
                          ...
                          child: new Text("Pay ",style: TextStyle(fontSize: 20.0,color: Colors.white)),
                        ),
